...
export CLASSPATH=${DOMAIN_HOME}/chipsconfig/jmstool.jar:${DOMAIN_HOME}/chipsconfig/chips-common.jar:${DOMAIN_HOME}/chipsconfig/log4j-core.jar:${DOMAIN_HOME}/chipsconfig/log4j-api.jar:${DOMAIN_HOME}/chipsconfig/log4j-1.2-api.jar:${DOMAIN_HOME}/chipsconfig/jdom.jar:${DOMAIN_HOME}/chipsconfig/ssoRMI.jar:${DOMAIN_HOME}/chipsconfig/aqapi12.jar:${DOMAIN_HOME}/chipsconfig:${CLASSPATH}
